...
$query = "
    SELECT 
        ...
        SUM(enter_status = 'no' AND isaccepted = 'yes') AS not_entered_count,
        SUM(dinner_status = 'yes') AS used_dinner_count,
        SUM(dinner_status = 'no' AND isaccepted = 'yes') AS not_used_dinner_count,
        SUM(breakfast_status = 'yes') AS used_breakfast_count,
        SUM(breakfast_status = 'no' AND isaccepted = 'yes') AS not_used_breakfast_count,
        SUM(snack_status = 'yes') AS used_snack_count,
        SUM(snack_status = 'no' AND isaccepted = 'yes') AS not_used_snack_count,
