                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="container-xxl container-p-y">
                            <div class="misc-wrapper">
                                <h2 class="mb-2 mx-2">Unauthorized User</h2>
                                <p class="mb-4 mx-2">Oops! 🚫 You are not authorized to access this page.</p>
                                <div class="mt-3">
                                    <img src="admin\assets\img\illustrations\401 Error Unauthorized-cuate.png"
                                        alt="page-unauthorized-light" width="500" class="img-fluid" />
                                </div>
                            </div>
                        </div>
                        <!-- /Unauthorized -->
