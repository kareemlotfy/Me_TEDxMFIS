...
// Filter condition
$filter = "WHERE ticket_type = 'family'";
...
$countSql = "
    SELECT 
        SUM(CASE WHEN isaccepted = 'yes' AND ticket_type = 'family' THEN 1 ELSE 0 END) AS paid_count,
        SUM(CASE WHEN isaccepted = 'no' AND ticket_type = 'family' THEN 1 ELSE 0 END) AS unpaid_count,
        SUM(CASE WHEN isaccepted = 'reject' AND ticket_type = 'family' THEN 1 ELSE 0 END) AS rejected_count,
        SUM(CASE WHEN ticket_type = 'family' THEN 1 ELSE 0 END) AS total_users,
        SUM(CASE WHEN isaccepted = 'yes' AND ticket_type = 'family' THEN paid ELSE 0 END) AS total_profit
    FROM user_cred
    WHERE ticket_type = 'family'
";
...
if ($currentPage > 1) {
    ...
    echo "<li class='paginate_button page-item previous' id='DataTables_Table_0_previous'>
            <a href='admin/Tickets/family.php?$queryString' class='page-link'><i class='bx bx-chevron-left bx-18px'></i></a>
          </li>";
} else {
...
if ($totalPages <= 5) {
    ...
    if ($currentPage <= 3) {
        ...
        $queryString = http_build_query(array_merge($_GET, ['page' => 1]));
        echo "<li class='paginate_button page-item'>
                <a href='admin/Tickets/family.php?$queryString' class='page-link'>1</a>
              </li>";
        echo "<li class='paginate_button page-item disabled'><a class='page-link'>...</a></li>";
        ...
        echo "<li class='paginate_button page-item'>
                <a href='admin/Tickets/family.php?$queryString' class='page-link'>$totalPages</a>
              </li>";
    } else {
...
if ($currentPage < $totalPages) {
    ...
    echo "<li class='paginate_button page-item next' id='DataTables_Table_0_next'>
            <a href='admin/Tickets/family.php?$queryString' class='page-link'><i class='bx bx-chevron-right bx-18px'></i></a>
          </li>";
} else {
