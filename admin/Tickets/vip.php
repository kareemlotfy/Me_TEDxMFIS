...
$countSql = "
    SELECT 
        SUM(CASE WHEN isaccepted = 'yes' AND ticket_type = 'vip' THEN 1 ELSE 0 END) AS paid_count,
        SUM(CASE WHEN isaccepted = 'no' AND ticket_type = 'vip' THEN 1 ELSE 0 END) AS unpaid_count,
        SUM(CASE WHEN isaccepted = 'reject' AND ticket_type = 'vip' THEN 1 ELSE 0 END) AS rejected_count,
        SUM(CASE WHEN ticket_type = 'vip' THEN 1 ELSE 0 END) AS total_users,
        SUM(CASE WHEN isaccepted = 'yes' AND ticket_type = 'vip' THEN paid ELSE 0 END) AS total_profit
    FROM user_cred
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-start justify-content-between">
                                            <div class="content-left">
                                                ...
                                                <div class="d-flex align-items-center my-1">
                                                    <h4 class="mb-0 me-2">
                                                        <?php echo htmlspecialchars($totalProfit, ENT_QUOTES, 'UTF-8'); ?>
                                                    </h4>
                                                </div>
                                            </div>
                                            <div class="avatar">
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                    <div class="row">
                                        <div class="col-md-2" style="margin-top: 1.5rem; margin-bottom:1.5rem">
                                            <form action="admin/Tickets/vip.php" method="get">
...
if ($currentPage > 1) {
    ...
    echo "<li class='paginate_button page-item previous' id='DataTables_Table_0_previous'>
            <a href='admin/Tickets/vip.php?$queryString' class='page-link'><i class='bx bx-chevron-left bx-18px'></i></a>
          </li>";
} else {
...
if ($totalPages <= 5) {
    ...
    for ($i = 1; $i <= $totalPages; $i++) {
        ...
        if ($i == $currentPage) {
            echo "<li class='paginate_button page-item active'>
                    <a href='admin/Tickets/vip.php?$queryString' class='page-link'>$i</a>
                  </li>";
        } else {
    ...
    if ($currentPage <= 3) {
        ...
        $queryString = http_build_query(array_merge($_GET, ['page' => 1]));
        echo "<li class='paginate_button page-item'>
                <a href='admin/Tickets/vip.php?$queryString' class='page-link'>1</a>
              </li>";
        echo "<li class='paginate_button page-item disabled'><a class='page-link'>...</a></li>";
        ...
        echo "<li class='paginate_button page-item'>
                <a href='admin/Tickets/vip.php?$queryString' class='page-link'>$totalPages</a>
              </li>";
    } else {
...
if ($currentPage < $totalPages) {
    ...
    echo "<li class='paginate_button page-item next' id='DataTables_Table_0_next'>
            <a href='admin/Tickets/vip.php?$queryString' class='page-link'><i class='bx bx-chevron-right bx-18px'></i></a>
          </li>";
} else {
