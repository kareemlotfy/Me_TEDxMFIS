...
if (isset($_GET['id'])) {
    ...
    // get user id from db
    $sql = "SELECT * FROM user_cred WHERE id = $userId";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $enter_status = $_POST["enter_status"];
    $dinner_status = $_POST["dinner_status"];
    

    // Update user information in the db
    $updateSql = "UPDATE user_cred SET
...
<form method="post" action="">
    ...
    <input type="text" name="ticket_id" value="<?php echo $userDetails['ticket_id']; ?>" required disabled>
    ...
    <input type="text" name="enter_status" value="<?php echo $userDetails['enter_status']; ?>" required disabled>
    ...
    <input type="text" name="dinner_status" value="<?php echo $userDetails['dinner_status']; ?>" required disabled>
