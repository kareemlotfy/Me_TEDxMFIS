...
// Fetch Early Bird ticket details (id = 1)
function getEarlyBirdTicket($con) {
...
// Example usage
$earlyBird = getEarlyBirdTicket($con);

$early_price    = $earlyBird['ticket_price'];
$early_discount = $earlyBird['ticket_discount'];
$early_final    = $early_price - $early_discount;

$ticket_status1 = getTicketStatus($con, 1); // Early Bird status
...
<head>
    ...
    <title>Early Bird Ticket Form</title>
</head>
        ...
        <div class="container">
            <div class="payment-wrapper">
                <div class="payment-right">
                    <div class="main">
                        <h1>Early Bird Ticket Form</h1>
                        <form id="myForm" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> method="post">
                            <input type="hidden" name="ticket_type" value="single">
                            <input type="hidden" name="ticket_sub_type" value="early bird">
                            <!-- Account Information Start -->
                            <h4>Your Information</h4>
                            <div class="input_group">
                                <div class="input_box">
                                    <input type="text" class="name" id="first_name" name="first_name" placeholder=" ">
                                    <label for="first_name" class="payment-form-label payment-form-label-required">First
                                        Name</label>
                                ...
                                <div class="input_box">
                                    ...
                                    <label for="last_name" class="payment-form-label payment-form-label-required">Last
                                        Name</label>
                                    <!-- <i class="fa fa-user icon"></i> -->
                                    <i class="fi fi-rr-user icon"></i>
                                </div>
                            ...
                            <div class="input_group" id="st-yes2">
                                <div class="input_box">
                                    <h4>Learning Type</h4>
                                    <input type="radio" id="National" name="learning_type" class="radio" value="National">
                            ...
                            <div class="input_group">
                                <div class="input_box">
                                    <input type="radio" name="payment_method" id="bc1" class="radio" value="instapay">
                            ...
                            <dialog class="payment_details" id="instaPayDialog">
                                ...
                                <ol>
                                    ...
                                    <li>And send a message with the phone number you wrote in the form to the WhatsApp number above.</li>
                                </ol>
                                ...
                                <ol>
                                    ...
                                    <li>Then send a screenshot of the transaction to this number: <strong>01505335101</strong> on WhatsApp.</li>
                                    <li>Send a message with the phone number you wrote in the form.</li>
                                </ol>

                                <p style="font-size:30px; text-align:center;"><strong style="color: var(--ted-color);"><i class="fa-solid fa-triangle-exclamation"></i> Important Notes</strong></p>
                                <ol style="margin-top:20px;">
                                    <li>Make Sure You Entered The Correct Amount</li>
                                    <li>Make Sure To Send the Screenshot to the WhatsApp Number Above to Get Your Ticket</li>
                                    <li>Make Sure to Send the Correct Number You Wrote in the Form to the WhatsApp Number</li>
                                </ol>
                               
                                <div class="input_box">
                                    <a href="index.php"><button type="button" onclick="closeDialog('instaPayDialog')">Okay</button></a>
                                </div>
                            </dialog>
                            ...
                            <dialog class="payment_details" id="cashAtSchoolDialog">
                                ...
                                <p>📍 Location : <a href="https://maps.app.goo.gl/JUi2FjJ8y4J9fkGy6" target="_blank" rel="noopener noreferrer">MFIS</a></p>
                                <ol>
                                    <strong>You will receive the ticket by email upon payment.</strong>
                                    <p>You can contact one of the numbers bellow on WhatsApp a day prior to pay for your ticket at school</p>
                                    <br>
                                    <li>National (Girls)<br>Saja -  0 114 334 3433<br>Rahma -  0 114 150 3289</li>
                                    <br>
                                    <li>IGCSE<br>Ahmed ElMahyy - 0 111 140 4422<br>Rovan ahmed - 0 100 333 9063<br>Moaz Hany - 0 101 556 3533<br>Roshan - 0 100 375 3556<br>Lamis Abdullah - 0 109 550 0623<br>Belal - 0 111 132 9858</li>
                                    <br>
                                    <li>National (Boys)<br>Omar tamer - 0 103 268 3677<br>Hassan - 0 100 689 9750<br>Omar ashraf - 0 122 701 5734<br>Moaz M. - 0 106 059 2908<br>Youssef - 0 106 628 5905</li>
                                </ol>
                                <div class="input_box">
                    ...
                    <div class="payment-content">
                        <div class="payment-body">
                            <div class="payment-plan">
                                <div class="payment-plan-type">Early</div>
                                <div class="payment-plan-info">
                                    <div class="payment-plan-info-name">Early Bird (single) Ticket</div>
                                    <div class="payment-plan-info-price" id="ticket_price"><?= htmlspecialchars($early_price) ?> EGP</div>
                                </div>
                            </div>
                            <div class="payment-summary">
                                <div class="payment-summary-item">
                                    <div class="payment-summary-name">Discount</div>
                                    <div class="payment-summary-price" id="ticket_discount"><?= htmlspecialchars($early_discount) ?> EGP</div>
                                </div>
                                <div class="payment-summary-divider"></div>
                                <div class="payment-summary-item payment-summary-total">
                                    <div class="payment-summary-name">Total</div>
                                    <div class="payment-summary-price" id="ticket_total"><?= htmlspecialchars($early_final) ?> EGP</div>
                                </div>
                            </div>
                        </div>
                    </div>
